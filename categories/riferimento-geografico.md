...
- **Macerata** (`5697902`)
  - **Apiro** (`5698265`)
  - **Appignano** (`5698268`)
  - **Belforte del Chienti** (`5698271`)
  - **Bolognola** (`5698274`)
  - **Caldarola** (`5698277`)
  - **Camerino** (`5698280`)
  - **Camporotondo di Fiastrone** (`5698283`)
  - **Castelraimondo** (`5698286`)
  - **Castelsantangelo sul Nera** (`5698289`)
  - **Cessapalombo** (`5698292`)
  - **Cingoli** (`5698295`)
  - **Civitanova Marche** (`5698298`)
  - **Colmurano** (`5698301`)
  - **Corridonia** (`5698304`)
  - **Esanatoglia** (`5698307`)
  - **Fiastra** (`5698310`)
  ...
  - **Matelica** (`5698328`)
  - **Mogliano** (`5698331`)
  - **Montecassiano** (`5698334`)
  - **Monte Cavallo** (`5698337`)
  - **Montecosaro** (`5698340`)
  - **Montefano** (`5698343`)
  - **Montelupone** (`5698346`)
  - **Monte San Giusto** (`5698349`)
  - **Monte San Martino** (`5698352`)
  - **Morrovalle** (`5698355`)
  - **Muccia** (`5698358`)
  - **Penna San Giovanni** (`5698361`)
  - **Petriolo** (`5698364`)
  - **Pieve Torina** (`5698367`)
  - **Pioraco** (`5698370`)
  - **Poggio San Vicino** (`5698373`)
  - **Pollenza** (`5698376`)
  - **Porto Recanati** (`5698379`)
  - **Potenza Picena** (`5698382`)
  - **Recanati** (`5698385`)
  - **Ripe San Ginesio** (`5698388`)
  - **San Ginesio** (`5698391`)
  - **San Severino Marche** (`5698394`)
  - **Sant'Angelo in Pontano** (`5698397`)
  - **Sarnano** (`5698400`)
  - **Sefro** (`5698403`)
  - **Serrapetrona** (`5698406`)
  - **Serravalle di Chienti** (`5698409`)
  - **Tolentino** (`5698412`)
  - **Treia** (`5698415`)
  - **Urbisaglia** (`5698418`)
  - **Ussita** (`5698421`)
